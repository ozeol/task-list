                            ...
                            <table class="table table-striped">
                                @foreach ($user->tasks->sortBy('title') as $task)
                                    ...
                                    <td style="padding-right:0px;">
                                            ...
                                            <follow-button style="padding-right:0px;" user-id="{{ $user->id }}" item="{{ $task }}"></follow-button>
                                      ...
                                      <td class="text-right" style="padding-left:0px;">
                                            ...
                                            <div class="d-flex  float-right" style="padding-left:0px;">
                                             ...
                                             <!--   <form method="POST" style="padding-right:4px;" action="{{ route('task.complete', $task->id) }}">
                                                ...
                                                <form method="POST" style="padding-left:0px; padding-right:4px;" action="{{ route('task.delete', $task->id) }}">
